...
adv_test_x = fgsm.generate_np(data_test, eps=epsilon, ord=2, clip_min=0., clip_max=1.)
...
print("Accuracy after attack, no defense")
...
pp_ae = load_model('pp_auto_encoder_mismatch_linf.h5')
...
print("Accuracy of perturbed data using DAE (trained with actual classifier for l-inf attack) as Defense")
print ("Accuracy: %.2f%%" %(adv_scores[1]*100))

#Load dimensionality reduction AE
red_dim_ae = load_model('../saved_models/autoencoders/784-331-784_100epochs.h5')
...
#Load classifier with input dimension of 331
red_dim_classifier = load_model('../saved_models/classifiers/331-100_100epochs.h5')
