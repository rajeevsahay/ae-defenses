...
#Loss minimizes to 0.0032 over 150 epochs using mean squared error and adam
...
#Create adversarial examples on testing data using programmer's original classifier
...
#Save the model
model.save('pp_auto_encoder_mismatch.h5')
