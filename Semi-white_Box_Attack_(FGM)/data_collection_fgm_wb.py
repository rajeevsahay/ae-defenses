...
#Load pre-processing DAE
pp_ae_linf_eps25 = load_model('../Semi-white_Box_Attack_(FGSM)/pp_auto_encoder_fgsm.h5')
...
for idx, epsilon in enumerate(e):
    ...
    #Run testing data through DAE pre-processor
    denoised_data = pp_ae_linf_eps25.predict(adv_test_x)

    #Evaluate accuracy of classifier after pre-processing
    adv_scores = fc_classifier.evaluate(denoised_data, labels_test)
    data[idx, 3] = adv_scores[1]*100 #attacked and defended using DAE trained on eps=0.25
    ...
    #Cascade defenses
    series_defense_data_20 = ae_hidden_representation_20([denoised_data])
    ...
    series_defense_data_40 = ae_hidden_representation_40([denoised_data])
    ...
    series_defense_data_60 = ae_hidden_representation_60([denoised_data])
    ...
    series_defense_data_80 = ae_hidden_representation_80([denoised_data])
    ...
    series_defense_data_100 = ae_hidden_representation_100([denoised_data])
    ...
    series_defense_data_331 = ae_hidden_representation_331([denoised_data])
...
np.savetxt("fgm_whitebox_using_linf_dae.csv", data, delimiter=",")
